...
//    [PointerType size=64]->[PointerType size=64]->[Struct size=128,fid: f7]
//*/
  fun ber_flatten(ber: NullablePointer[_Berelement] tag): (I32, NullablePointer[_Berval])  =>
    var bvPtr: NullablePointer[_Berval] = NullablePointer[_Berval].none()
    (@ber_flatten(ber, addressof bvPtr), bvPtr)
